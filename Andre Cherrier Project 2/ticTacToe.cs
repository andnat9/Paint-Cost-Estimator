...
using Andre_Cherrier_Project_2;
...
namespace Andre_Cherrier_Project_1
{
    public partial class ticTacToeBoard : Form
    {
        ...
        private void xButton_Checked(object sender, EventArgs e)
        {
        ...
        private void oButton_Checked(object sender, EventArgs e)
        {
        ...
        {
            MessageBox.Show("I told you not to click...");
            this.BringToFront();
        }
